...
{
    public class GetAddRemoveChannelsHandlerShould
    {
        ...
        {
            _ = await _conductor.AddChannelAsync(nameof(GetAddRemoveChannelsHandlerShould), ClassificationType.Product, "http://some.url", "feature/some-feature");
