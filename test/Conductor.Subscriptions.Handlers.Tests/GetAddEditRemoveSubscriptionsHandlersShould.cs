...
namespace Conductor.Subscriptions.Handlers.Tests
{
	public class GetAddEditRemoveSubscriptionsHandlersShould
	{
		...
		{
			var channel = await _conductor.AddChannelAsync(nameof(GetAddEditRemoveSubscriptionsHandlersShould), ClassificationType.Product, "http://some.url", "feature/some-feature");
